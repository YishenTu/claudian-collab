...
function record() {
  return {
    ...
    newAuthority: {
      bindingVersion: 10,
      gitRemoteUrl: 'http://new.example.test/operator/v3/v10/projects/project-cloud/repository.git',
      serverUrl: 'http://new.example.test/operator/v3',
      wireVersion: 15,
    },
    oldAuthority: {
      bindingVersion: 10,
      gitRemoteUrl: 'https://old.example.test/root/v10/projects/project-cloud/repository.git',
