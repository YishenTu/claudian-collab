...
- Review leaves are session-only: remove restored reviews at startup and clear their view state before unload layout persistence without removing workspace leaves. Persist identifiers/selection only, never credentials or content.
